        ...
        return (
            <div className="col-left animate-element wow delay5 fadeInDown" data-wow-delay="0.5s">
                <div className="flat-title t1">
                    <h4 className="sub-title mb-2">Logo Design</h4>
                    <h2 className="title-section color-d12 mg-b34">Some of my work and projects</h2>
                    <div className="description">
                        <p className="lt-sp01">
                        Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or designs. 
                        </p>
                        <p className="lt-sp01">
