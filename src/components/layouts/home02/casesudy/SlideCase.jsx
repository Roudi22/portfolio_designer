    ...
    constructor(props) {
        ...
        this.state = {
            slider: [
                {
                    id: 1,
                    image: './images/section/logo1.jpg',
                    alt: 'images',
                    title: 'Portfolio',
                    view: 'Full view'
                },
                {
                    id: 2,
                    image: './images/section/logo2.jpg',
                    alt: 'images',
                    title: 'Portfolio',
                    view: 'Full view'
                },
                {
                    id: 3,
                    image: './images/section/logo3.jpg',
                    alt: 'images',
                    title: 'Drop',
                    view: 'Full view'
                },{
                            ...
                            this.state.slider.map(data => (
                                <div className="image-box-t1" key={data.id}>
                                    <div className="featured-post">
                                        <img style={{boxShadow: "5px 10px 18px #888888"}} src={data.image} alt={data.alt} />
                                    </div>
